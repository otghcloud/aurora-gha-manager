...
/**
 * DataTable for recorded GitHub workflow jobs.
 */
class WorkflowJobsDataTable extends DataTable
{
    ...
    public function query(WorkflowJob $model): QueryBuilder
    {
        ...
        $conclusion = is_numeric($conclusion) ? (int) $conclusion : null;
    ...
    /** Build the DataTable client configuration. */
    ...
    /** Return the download filename used by export buttons. */

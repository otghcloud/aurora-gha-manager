...
/**
 * View helpers for rendering model breadcrumb metadata.
 */
class BreadcrumbHelpers
{
     ...
     */
    /** @return array<int, array{label: string, href: string|null, active: bool}> Breadcrumb entries for the current request. */

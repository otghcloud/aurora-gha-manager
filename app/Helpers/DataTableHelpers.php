...
/**
 * Shared HTML and display helpers for server-side DataTables.
 */
class DataTableHelpers
{
     ...
     */
    /** @param array<string, array<string, mixed>> $actions @return string Rendered action dropdown HTML. */
     ...
     */
    /** Format a duration in seconds for DataTable display. */

...
/**
 * Presents image builds and build log actions.
 */
class BuildController extends Controller
{
     ...
     */
    /** Return build log content or a streamed log response. */

...
/**
 * Provides operational diagnostics and maintenance actions.
 */
class DebugController extends Controller
{
    ...
    /** Display diagnostics and maintenance controls. */
    ...
    /** Toggle a debug setting from the submitted control. */
    ...
    /** Request a forced runner cleanup pass. */
    ...
    /** Delete retained runner history. */
     ...
     */
    /** Delete retained image build history. */
    ...
    /** Delete retained webhook delivery records. */
     ...
     */
    /** Delete retained workflow job records and logs. */
     ...
     */
    /** Stream the current non-secret application configuration. */
    public function exportConfig(): StreamedResponse
    {
        $zipFilename = 'aurora-gha-manager-export-'.date('YmdHis').'.zip';

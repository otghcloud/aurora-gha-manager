...
/**
 * Manages template catalog and retention settings.
 */
class TemplatesController extends Controller
{
    public function __construct(private readonly SettingsRepository $settings) {}

    /** Display template catalog and download settings. */
    ...
    /** Persist template download settings. */
    ...
    /** Display template retention settings. */
    public function retention(): View
    {
        return view('pages.settings.templates-retention', [
            'settings' => $this->settings->all(),
        ]);
    }

    /** Persist template retention settings. */
    public function updateRetention(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('settings.templates.retention')
            ->with('success', 'Retention settings saved.');
    }

    /** Check the remote template catalog for updates. */
    ...
    /** Download the selected template catalog update. */
    ...
    /** Activate an installed template catalog version. */

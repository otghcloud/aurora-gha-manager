...
/**
 * Validates runner pool labels, limits, and target preferences.
 */
class PoolRequest extends FormRequest
{
    /** Allow authenticated administrators to submit pool changes. */
     ...
     */
    /** @return array<string, mixed> Validation rules for pool settings. */
    ...
    /** @return array<int, callable> Additional validation callbacks. */
     ...
     */
    /** @return array<int, array<string, int>> Normalized per-target limits. */
    ...
    /** Normalize target limits before validation. */

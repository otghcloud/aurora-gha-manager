...
/**
 * A provisioned GitHub Actions runner VM tracked through its lifecycle.
 */
class Runner extends Model
{
    ...
    /** @return BelongsTo<Pool, $this> Source pool. */
    ...
    /** @return HasMany<RunnerEvent, $this> Recorded lifecycle events. */
    public function events(): HasMany
    {
        return $this->hasMany(RunnerEvent::class);
    }

    /** @return HasMany<WorkflowJob, $this> Jobs served by this runner. */
     ...
     */
    /** @return HasOne<WorkflowJob, $this> Most recent served job. */
    public function servedJob(): HasOne
    {
        return $this->hasOne(WorkflowJob::class)->latestOfMany();
    }

    /** Restrict the query to active runner states. */
    public function scopeActive(Builder $query): Builder
    {
        return $query->whereIn('state', RunnerState::activeValues());
    }

    /** Restrict the query to one environment model or identifier. */
    ...
    /** Return the runner age in seconds. */
     ...
     */
    /** Persist a state transition and append its immutable event record. */

...
/**
 * Loads and queries the installed runner template catalog.
 */
class TemplateCatalog
{
    /** Return the configured catalog manifest path. */
    public function path(): string
    {
        return $this->root().'/templates.json';
    }

    /** Return the root directory containing catalog assets. */
    ...
    /** Resolve a catalog entry and optional builder selection. */
    ...
    /** Return the local template directory for an entry, if installed. */

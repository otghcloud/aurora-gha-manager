...
class WorkflowJobRecorder
{
    ...
    public function record(Environment $environment, array $job, array $body, ?Runner $runner = null): ?WorkflowJob
    {
        ...
        $attributes = array_filter([
            ...
            'status' => $status,
            'conclusion' => $this->conclusion($job['conclusion'] ?? null),
    ...
    private function conclusion(mixed $value): ?JobConclusion
    {
        return is_string($value) && $value !== '' ? JobConclusion::fromSlug($value) : null;
    }

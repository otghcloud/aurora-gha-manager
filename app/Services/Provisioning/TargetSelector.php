...
/**
 * Selects viable Proxmox targets for a runner template or pool.
 */
class TargetSelector
{
     ...
     */
    /** @param array<int, string> $labels Select one eligible target for labels. */
     ...
     */
    /** @param array<int, string> $labels @return Collection<int, ProxmoxTarget> Eligible targets. */

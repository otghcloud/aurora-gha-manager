...
/**
 * Checks for and records updates to the installed template catalog.
 */
class TemplateUpdateService
{
    public const REMOTE_URL = 'https://raw.githubusercontent.com/otghcloud/aurora-gha-manager-templates/refs/heads/main/templates.json';

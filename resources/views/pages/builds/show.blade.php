										...
										<div class="build-stage-list">
											@foreach ($progress['groups'] as $group)
												<div class="build-stage-group build-stage-group-{{ $group['state'] }}" data-build-stage-group="{{ $group['id'] }}">
													<button class="build-stage-group-header" type="button" data-build-stage-toggle aria-expanded="{{ $group['state'] === 'current' ? 'true' : 'false' }}">
													...
													<div class="build-stage-group-stages" @if ($group['state'] !== 'current') hidden @endif>

...
class RunnerTemplateMappingTest extends TestCase
{
    ...
    public function test_image_list_ajax_endpoints_render_catalog_aligned_records(): void
    {
        ...
        $template = RunnerTemplate::create(['environment_id' => $environment->id, 'name' => 'Ubuntu 24.04', 'os' => 'linux', 'template_catalog_id' => 'ubuntu-24.04']);
        ...
        ImageBuild::create(['environment_id' => $environment->id, 'runner_template_id' => $template->id, 'proxmox_target_id' => $node->id, 'template_catalog_id' => 'ubuntu-24.04', 'status' => BuildStatus::Queued]);
    ...
    public function test_build_now_rejects_an_unconfigured_node_without_server_error(): void
    {
        ...
        $template = RunnerTemplate::create(['environment_id' => $environment->id, 'name' => 'Ubuntu', 'os' => 'linux', 'template_catalog_id' => 'ubuntu-24.04']);
    ...
    public function test_builds_for_the_same_template_can_run_on_different_nodes(): void
    {
        ...
        ImageBuild::create(['environment_id' => $environment->id, 'runner_template_id' => $template->id, 'proxmox_target_id' => $nodeA->id, 'template_catalog_id' => 'ubuntu-24.04', 'status' => BuildStatus::Running]);

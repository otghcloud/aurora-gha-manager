...
class TemplateCatalogTest extends TestCase
{
            ...
            'templates' => [[
                ...
                'builders' => [
                    'cloudimage' => [
                        ...
                        'type' => 'cloudimage',
                        'path' => 'templates/ubuntu/ubuntu-slim/cloudimage',
                        'build_manifest' => 'templates/ubuntu/ubuntu-slim/cloudimage/build.json',
    ...
    public function test_packer_is_preferred_while_cloudimage_is_not_buildable(): void
    {
    ...
    public function test_a_cloudimage_only_template_is_not_yet_buildable(): void
    {
        ...
        $this->assertSame('cloudimage', $entry->builderType());
    ...
    {
        $entry = (new TemplateCatalog)->entryForId('ubuntu-slim', 'cloudimage');

        $this->assertSame('cloudimage', $entry->builderName());
        $this->assertSame('cloudimage', $entry->builderType());
    }
}
